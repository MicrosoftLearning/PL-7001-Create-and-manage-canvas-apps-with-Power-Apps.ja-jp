...
1. **[データから開始]** の下にある **[Excel Online (Business)]** タイルを選択します。

    ![[データから開始] タイルのスクリーンショット。](../media/start-from-data.png)
...
1. Power Apps Studio の右上にある **[保存]** を選択し、**[名前]** に「`Coffee Machines App`」と入力して、**[保存]** を選択します。
...
1. **[+ 新しいアプリ]** ドロップダウン、**[Copilot で開始]** の順に選択します。
...
1. Power Apps Studio の右上にある **[保存]** を選択し、**[名前]** に「`Coffee Machine Repairs App`」と入力して、**[保存]** を選択します。
