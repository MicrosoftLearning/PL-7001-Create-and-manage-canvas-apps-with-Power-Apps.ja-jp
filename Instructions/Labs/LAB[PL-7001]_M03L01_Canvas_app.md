...
1. **[デザインから開始]** の下の **[一から作成]** タイルを選択します。

1. **[タブレット サイズ]** を選択します。

1. 空のアプリが作成されるまで待ちます。

1. Power Apps Studio の右上にある **[保存]** を選択し、**[名前]** に「`Booking Request app`」と入力して、**[保存]** を選択します。
...
1. **[本文 1]** で **[コスト]** を選びます。
   ...
   > [!NOTE]
   > フィールド名は、表示名の代わりに、プレフィックスを付けたスキーマ名として表示される場合があります。
