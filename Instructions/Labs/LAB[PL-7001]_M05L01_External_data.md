...
1. **[チーム サイト]**、**[Standard team]** テンプレート、**[テンプレートの使用]** の順に選択します。
...
1. 数式バーで **UserDetailsLabel** の **Text** プロパティを次の値に設定します。
    ...
    ```
> [!NOTE]
> ユーザーの国が表示されない場合は、`https://admin.microsoft.com` に移動し、**[ユーザー]**  >  **[アクティブ ユーザー]** の順に選択してユーザー プロファイルを選択し、**[連絡先情報の管理]** を選択し、**[国またはリージョン]** フィールドを任意の国に設定して、**[変更の保存]** を選択します。
