...
1. **[ツリー ビュー]** の **[MainScreen]** の下にある **[BookingRequestList]** を展開します。
...
1. アイコンの名前を `BackIconEdit` に変更します。
...
1. **[プロパティ]** ペインで、**[フィールド]** の横に表示されているリンク (たとえば、**[8 個が選択済み]**) を選択します。

    ![既定のフォーム フィールドのスクリーンショット。](../media/add-fields-default.png)

1. フィールドが次の順序で配置されるように、フィールドを追加または削除します。
...
1. **[プロパティ]** ペインで、**[フィールド]** の横に表示されているリンク (たとえば、**[9 個が選択済み]**) を選択します。
